...
```bash
cd ~/repos/[name]-mcp && pnpm install
```
...
"[name]": {
  ...
  "args": [
    "tsx",
    "/Users/brenner/repos/[name]-mcp/src/index.ts"
  ]
}
```
...
- [ ] Project created in `~/repos/[name]-mcp/`
...
- `/Users/brenner/repos/hunter-mcp/` - Simple API with fetch
- `/Users/brenner/repos/twilio-mcp/` - Using an SDK client
- `/Users/brenner/repos/anylist-mcp/` - Async client initialization
